...
cy.get(':nth-child(1) > label > .color-container > .color').click()
...
cy.get('#product_attribute_68_7_13').click()
cy.get(':nth-child(3) > label > .color-container > .color').click()
cy.get('.compare-products > .button-2').click()
cy.contains('Apparel & Shoes').should('be.visible')
cy.get('.top-menu > :nth-child(4) > a').click()
//
...
//
//VERIFICANDO DE APARECE ERRO NO TESTANDO LOGAR COM E-MAIL DO GOOGLE - E-MAIL JÁ EXISTENTE
