...
//AQUI ELE FICA NO CENTRO DA TELA
...
//FIM
    ...
    //
    cy.scrollTo(0, 800) // Scroll the window 500px down
    cy.get('.sidebar').scrollTo('bottom') // Scroll 'sidebar' to its bottom
    cy.get('#dlArtigosFiltrados_ctl02_wctArtigoMaisVendidosFull1_btnSacola').click();
    cy.scrollTo(0, 300) // Scroll the window 500px down
    cy.get('.sidebar').scrollTo('bottom') // Scroll 'sidebar' to its bottom
    cy.get('#lnkComprar')
    //
